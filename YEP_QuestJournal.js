...
* @default
* 
* @param Number of quests
* @parent ---Quest List---
* @type number
* @desc Modify this number to match number of quests
* @default 100
*
* @param Quest 1
* @parent ---Quest List---
...
if (Utils.RPGMAKER_VERSION && Utils.RPGMAKER_VERSION >= "1.3.5") {
  ...
  Yanfly.Param.NumberOfQuests = Number(Yanfly.Parameters['Number of quests']);
  ...
  DataManager.questDatabaseCreate = function () {
    $dataQuests = [null];
    for (var i = 1; i <= Yanfly.Param.NumberOfQuests; ++i) {
  ...
  Window_QuestCategories.prototype.initialize = function (x, y, width, height) {
    if (width == undefined) width = this.windowWidth();
    if (height == undefined) height = this.windowHeight();
    if (x == undefined) x = Math.round(eval(this.settings('X')));
    if (y == undefined) y = Math.round(eval(this.settings('Y')));
  ...
  Window_QuestCategories.prototype.windowWidth = function () {
    if (this._windowWidth === undefined) {
      console.log('wtf why this is undefied');
      this._windowWidth = Math.round(eval(this.settings('Width')));
    }
    return this._windowWidth;
  };
  ...
  Window_QuestCategories.prototype.drawItem = function (index) {
    ...
    console.log('drawTexEx(' + text + ', ' + wx.toString() + ', ' + rect.y.toString() + ')');
