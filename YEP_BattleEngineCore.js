...
//original code block, glb
*/

//elBlanquito: moved this from SVActorPosition.js and integrated the variable names from the above function
// into the below code! 30NOV2017
// --------------------
...
Sprite_Weapon.prototype.setPosition = function () {
  ...
  //var actorBitmap = this.parent._mainSprite.bitmap;               		//elblanquito, 30NOV2017: I commented all of this out because
  //var actorSpriteWidth = Sprite_Actor.prototype.spriteWidth;      		//it is unnecessary when each skill will have custom WeaponPlacement tags 
  //var actorSpriteWidth = actorBitmap ? actorBitmap.width / 9 : 64;		//associated with it
  this.x = -16;
  ...
  //var weaponPositionOffsetX = $gameVariables.value[50];
  //var weaponPositionOffsetY = $gameVariables[6];

  var battler = this.parent._battler;
  if (battler) {


    this.x += (Yanfly.weaponRight || 0); //I changed the input of the parameter to directly call a global variable I defined in YEP_SkillCore.js. elblanquito
    this.y += (Yanfly.weaponHeight || 0);
  }
};
