...
Moghunter.title_splash_sound = (Moghunter.parameters['Splash Sound'] || 'celestium_shard');
...
Scene_Splash_Screen.prototype.refresh_splash_screen = function() {
   ...
   if (this._splash_data[0] == 1) {
       setTimeout(function() {
           AudioManager.playSe({name:Moghunter.title_splash_sound, volume:90, pitch:100, pan:0});
