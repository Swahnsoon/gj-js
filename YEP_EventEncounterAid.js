...
*
*   this.checkPlayerFacingEvent()
*   - Returns true if the player is facing the event.
*
...
//Scriptcall checking if player is facing event from - TIKA add-on.
Game_Interpreter.prototype.checkPlayerFacingEvent = function () {
  return this.checkPlayerFacingEventFront() || this.checkPlayerFacingEventBack() || this.checkPlayerFacingEventSide();
};